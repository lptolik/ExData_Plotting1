...
plot(dat$tm,dat$Voltage,type='l',xlab='datetime',ylab='Voltage',main=NA)
...
plot(dat$tm,dat$Global_reactive_power,type='l',xlab='datetime',ylab='Global_reactive_power',main=NA)
dev.off()